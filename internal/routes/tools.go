...
func toolGraph() map[string]any {
	return map[string]any{
		...
		"focusa_integration": map[string]any{
			...
			"packet_metadata_surfaces": []string{"search", "browser_read", "browser_diagnostics", "structured_errors"},
...
func toolRelations() map[string][]string {
	return map[string][]string{
		...
		"uiai_focusa_packet_build":  {"focusa_evidence_capture", "focusa_browser_diagnostics_intake", "focusa_active_object_resolve", "focusa_predict_record", "browser_close"},
