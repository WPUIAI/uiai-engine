...
- Search provider behavior: `/api/search/providers` reports configured/degraded readiness without secrets; Brave calls use a bounded 12s provider timeout and upstream quota/rate limits remain provider-account concerns.
