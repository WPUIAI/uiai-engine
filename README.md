...
- Project-local Pi skills: [`.pi/skills/uiai-agent/SKILL.md`](.pi/skills/uiai-agent/SKILL.md) is the main UIAI agent workflow skill; [`.pi/skills/vision/SKILL.md`](.pi/skills/vision/SKILL.md) is the browser/vision workflow skill. Global copies under `~/.pi/skills/` are convenience installs only and should be refreshed from repo copies when UIAI workflows change.
