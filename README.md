...
- Project-local Pi skill: [`.pi/skills/vision/SKILL.md`](.pi/skills/vision/SKILL.md) is the repo-versioned UIAI browser/vision workflow skill. Global copies under `~/.pi/skills/` are convenience installs only and should be refreshed from this repo copy when UIAI workflows change.
