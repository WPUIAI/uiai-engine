...
- Browser/session and screenshot APIs are loopback-public only; remote callers must authenticate.
...
- Remote browser/session/screenshot callers require normal UIAI auth headers.
