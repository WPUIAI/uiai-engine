...
![Last Commit](https://img.shields.io/github/last-commit/WPUIAI/uiai-engine)
![Repo Size](https://img.shields.io/github/repo-size/WPUIAI/uiai-engine)
![Code Size](https://img.shields.io/github/languages/code-size/WPUIAI/uiai-engine)
![Top Language](https://img.shields.io/github/languages/top/WPUIAI/uiai-engine)
![Issues](https://img.shields.io/github/issues/WPUIAI/uiai-engine)
...
Use UIAI Engine when [Focusa](https://github.com/Startempire-Wire/focusa)-powered agents need a browser they can explain, prove, and hand off. The cohort value proposition is simple:
...
3. **Keep agents on track with [Focusa](https://github.com/Startempire-Wire/focusa):** [Focusa](https://github.com/Startempire-Wire/focusa) binds browser evidence to project identity, Workpoints, trajectory, predictions, metacog lessons, and next actions.
...
5. **Ship product output:** Source-to-Markdown and research packets produce WPUIAI research cards/reports plus [Focusa](https://github.com/Startempire-Wire/focusa)-ready capture arguments.
...
For users, this means less “the agent clicked around somewhere” and more “the agent inspected these sources, captured this evidence, diagnosed these failures, and [Focusa](https://github.com/Startempire-Wire/focusa) knows what to do next.” The current product already supports browser proof and [Focusa](https://github.com/Startempire-Wire/focusa) handoff; the planned FPV/PWA layer adds live operator oversight on top of that foundation.

## What this engine does

UIAI Engine serves as a single local or remote API surface for:

- **Agent integrations:** Pi extension tools, MCP browser-session bridge, OpenAI/MCP tool schemas, compact agent cards, provider-neutral web search, tool search, tool graph metadata, and [Focusa](https://github.com/Startempire-Wire/focusa)-aware evidence routes that make UIAI the proof browser inside [Focusa](https://github.com/Startempire-Wire/focusa)-powered workflows.
...
| Agent 2FA Integration: portable TOTP plus optional Aegis/aegis-rs vault adapter | [`docs/AGENT_2FA_INTEGRATION.md`](docs/AGENT_2FA_INTEGRATION.md) |
...
| Draft Source-to-Markdown spec: webpage/social/docs/issues/videos → Markdown/JSONL with agent discovery and [Focusa](https://github.com/Startempire-Wire/focusa) evidence | [`docs/SOURCE_TO_MARKDOWN_AGENT_SPEC.md`](docs/SOURCE_TO_MARKDOWN_AGENT_SPEC.md) |
...
| [Focusa](https://github.com/Startempire-Wire/focusa) packet examples gallery | [`docs/FOCUSA_PACKET_EXAMPLES_GALLERY.md`](docs/FOCUSA_PACKET_EXAMPLES_GALLERY.md) |
...
| UIAI × [Focusa](https://github.com/Startempire-Wire/focusa) × Pi hand-in-glove research/diagnostics/evidence packet spec | [`docs/UIAI_FOCUSA_PI_HAND_IN_GLOVE_SPEC.md`](docs/UIAI_FOCUSA_PI_HAND_IN_GLOVE_SPEC.md) |
...
- Interoperability quality spec: [`docs/UIAI_ENGINE_INTEROPERABILITY_QUALITY_SPEC.md`](docs/UIAI_ENGINE_INTEROPERABILITY_QUALITY_SPEC.md) covers WordPress, Pi, MCP, [Focusa](https://github.com/Startempire-Wire/focusa), browser diagnostics/errors, CLI, search/providers, auth/security, and proof gates.
...
Use [`docs/UIAI_ENGINE_INTEROPERABILITY_QUALITY_SPEC.md`](docs/UIAI_ENGINE_INTEROPERABILITY_QUALITY_SPEC.md) as the top-level matrix for WordPress, Pi, MCP, [Focusa](https://github.com/Startempire-Wire/focusa), browser diagnostics/errors, CLI, search/providers, auth/security, and proof gates.
...
UIAI Engine is the **proof browser for [Focusa](https://github.com/Startempire-Wire/focusa)-powered agents** and is licensed under the [Business Source License 1.1](LICENSE). The repo is source-available, not open source until the Change License takes effect for a version.
...
- Agent 2FA is opt-in through `two_factor` profiles. Native TOTP is portable; Aegis vault support uses a configurable `aegis` CLI from `Granddave/aegis-rs` as an optional command adapter and never links Aegis/GPL code into UIAI Engine.
...
For public/product positioning, lead with agent discovery, Source-to-Markdown, persistent browser workflows, diagnostics, [Focusa](https://github.com/Startempire-Wire/focusa)/Pi/MCP handoff, and WPUIAI research-card/report outputs.
