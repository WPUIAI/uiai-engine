...
checks={
 'integrations/pi/uiai-engine.ts':[schema,'uiai_focusa_packet_build','uiai_focusa_packet_compose','buildResearchDiagnosticsPacket','args_preview','headless_next_action'],
