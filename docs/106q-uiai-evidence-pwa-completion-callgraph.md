...
| CG-10 — T07 Action runtime | CG-09 | UIAI + Focusa | operation registry, preview/confirm, anti-replay, result/reconciliation, item-scoped review/adjudication/reproof/follow-up transport, untrusted-content handling, and no-local-completion authority implemented | ambiguity/partial/replay/rejection/reproof E2E + authority audit |
