...
|---|---|---|
| WPUIAI plugin UI/save for `wpuiai.research_card` | Engine returns product cards; plugin save/display flow implemented in WPUIAI plugin via `wpuiai_research` private posts | See `docs/WPUIAI_RESEARCH_CARD_INTEGRATION_CONTRACT.md` and plugin task `uiai-833` proof |
